                    ...
                    <div>
                      ...
                      <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 mb-6 tracking-tight">
                        ...
                        <div className="space-y-2 text-sm text-indigo-600 font-medium">
                           <Link to="/privacy-policy" className="flex items-center gap-2 hover:underline"><ChevronRight size={14} /> Privacy Policy</Link>
                           <Link to="/terms-and-conditions" className="flex items-center gap-2 hover:underline"><ChevronRight size={14} /> Terms &amp; Conditions</Link>
                           <Link to="/refund-policy" className="flex items-center gap-2 hover:underline"><ChevronRight size={14} /> Cancellation &amp; Refunds</Link>
                           <Link to="/shipping-policy" className="flex items-center gap-2 hover:underline"><ChevronRight size={14} /> Shipping Policy</Link>
                         </div>
                      </div>
                    </div>
