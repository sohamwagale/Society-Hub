      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-4">
          ...
          <p>
            ...
            regulations, privacy policy and Terms of Use for access or usage of domain name https://jazzy-mermaid-d74e54.netlify.app/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </p>
          <p>
            The Platform is owned by <strong>9552804518</strong> with its registered office at <strong>2575, Jamdar Tower, Kasaba Bavada</strong>, a company incorporated under the Companies Act, 1956 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
          </p>
          <p>
          ...
          <p className="font-semibold uppercase mt-8">
